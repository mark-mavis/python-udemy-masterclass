...
def colour_print(text: str, *effects: str) -> None:
  ...
  """
  effect_string = "".join(effects)    # Join Effects together in string
  output_string = "{0}{1}{2}".format(effect_string, text, RESET) # Append Console text and reset ASCII 
  print(output_string)
...
# The following function calls have multiple arguments for the effects because *effects
#   in the colour_print function takes them as a tuple
...
print("hello again")
colorama.deinit()
print("Hello after color de-initialize")
